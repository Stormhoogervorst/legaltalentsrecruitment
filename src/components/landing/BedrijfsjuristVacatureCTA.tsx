...
export function BedrijfsjuristVacatureCTA() {
  return (
      ...
      <SectionShell>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          ...
          <article className="flex flex-col rounded-[24px] bg-dark-background-secondary p-8 md:p-10">
            ...
            <h3 className="display-h3 mt-6">Een bedrijfsjurist werven</h3>
            <p className="mt-4 text-[16px] leading-[1.6] text-dark-foreground-secondary">
              Vertel waar jullie legal team naar zoekt. We denken mee over
              profiel, markt en tempo.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <PillButton href="/contact" variant="dark">
                Plan een gesprek →
