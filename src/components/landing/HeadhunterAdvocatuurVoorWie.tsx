...
export function HeadhunterAdvocatuurVoorWie() {
  return (
    <section className="bg-background py-16 text-foreground md:py-[120px]">
      <SectionShell>
        ...
        <aside className="mt-6 rounded-[24px] bg-background-secondary p-8 md:flex md:items-end md:justify-between md:gap-12 md:p-12">
          ...
          <div className="mt-8 flex shrink-0 flex-col gap-4 md:mt-0">
            <PillButton href="/voor-kandidaten">Voor kandidaten →</PillButton>
            <Link
              href="/vacatures"
              className="text-foreground transition-colors hover:text-foreground-secondary focus:outline-none focus-visible:ring-2 focus-visible:ring-foreground focus-visible:ring-offset-4 focus-visible:ring-offset-background-secondary"
            >
